...
public class CodificadorImagen {
    ...
    public static void main(String[] args) {
        ...
        for (String linea : lineas) {
            String codificacion = codificarImagen(linea);
    ...
    private static String codificarImagen(String linea) {
        StringBuilder codificacion = new StringBuilder();

        char valorInicial = linea.charAt(0);
        int contador = 1;
        ...
        return valorInicial + " " + codificacion.toString();
    }
}